...
{
  new (message_memory) person_mags::msg::Person(_init);
}

void Person_fini_function(void * message_memory)
{
  auto typed_message = static_cast<person_mags::msg::Person *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Person_message_member_array[2] = {
  {
    ...
    offsetof(person_mags::msg::Person, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(person_mags::msg::Person, age),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Person_message_members = {
  "person_mags::msg",  // message namespace
  "Person",  // message name
  2,  // number of fields
  sizeof(person_mags::msg::Person),
...
get_message_type_support_handle<person_mags::msg::Person>()
{
  return &::person_mags::msg::rosidl_typesupport_introspection_cpp::Person_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, person_mags, msg, Person)() {
  return &::person_mags::msg::rosidl_typesupport_introspection_cpp::Person_message_type_support_handle;
}
