...
#include "person_mags/msg/detail/person__functions.h"
...
person_mags__msg__Person__init(person_mags__msg__Person * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    person_mags__msg__Person__fini(msg);
    return false;
  }
  // age
  return true;
...
person_mags__msg__Person__create()
{
  ...
  person_mags__msg__Person * msg = (person_mags__msg__Person *)allocator.allocate(sizeof(person_mags__msg__Person), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(person_mags__msg__Person));
  bool success = person_mags__msg__Person__init(msg);
  if (!success) {
...
person_mags__msg__Person__Sequence__init(person_mags__msg__Person__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  person_mags__msg__Person * data = NULL;

  if (size) {
    data = (person_mags__msg__Person *)allocator.zero_allocate(size, sizeof(person_mags__msg__Person), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = person_mags__msg__Person__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        person_mags__msg__Person__fini(&data[i - 1]);
      }
...
person_mags__msg__Person__Sequence__fini(person_mags__msg__Person__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      person_mags__msg__Person__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  person_mags__msg__Person__Sequence * array = (person_mags__msg__Person__Sequence *)allocator.allocate(sizeof(person_mags__msg__Person__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = person_mags__msg__Person__Sequence__init(array, size);
  if (!success) {
...
person_mags__msg__Person__Sequence__destroy(person_mags__msg__Person__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    person_mags__msg__Person__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
person_mags__msg__Person__Sequence__are_equal(const person_mags__msg__Person__Sequence * lhs, const person_mags__msg__Person__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!person_mags__msg__Person__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  person_mags__msg__Person__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(person_mags__msg__Person);
    person_mags__msg__Person * data =
      (person_mags__msg__Person *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!person_mags__msg__Person__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          person_mags__msg__Person__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!person_mags__msg__Person__copy(
