...
#include <stddef.h>
#include "person_mags/msg/detail/person__rosidl_typesupport_introspection_c.h"
#include "person_mags/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  person_mags__msg__Person__init(message_memory);
}

void Person__rosidl_typesupport_introspection_c__Person_fini_function(void * message_memory)
{
  person_mags__msg__Person__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Person__rosidl_typesupport_introspection_c__Person_message_member_array[2] = {
  {
    ...
    offsetof(person_mags__msg__Person, name),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(person_mags__msg__Person, age),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Person__rosidl_typesupport_introspection_c__Person_message_members = {
  "person_mags__msg",  // message namespace
  "Person",  // message name
  2,  // number of fields
  sizeof(person_mags__msg__Person),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_person_mags
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, person_mags, msg, Person)() {
