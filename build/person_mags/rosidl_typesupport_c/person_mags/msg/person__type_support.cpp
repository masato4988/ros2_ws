...
#include "person_mags/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Person_type_support_symbol_names_t _Person_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, person_mags, msg, Person)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, person_mags, msg, Person)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_person_mags
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, person_mags, msg, Person)() {
  return &::person_mags::msg::rosidl_typesupport_c::Person_message_type_support_handle;
}
