...
#include "person_mags/msg/detail/person__rosidl_typesupport_fastrtps_c.h"
...
#include "person_mags/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Person__ros_msg_type = person_mags__msg__Person;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_person_mags
size_t get_serialized_size_person_mags__msg__Person(
  const void * untyped_ros_message,
...
static uint32_t _Person__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_person_mags__msg__Person(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_person_mags
size_t max_serialized_size_person_mags__msg__Person(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_person_mags__msg__Person(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, person_mags, msg, Person)() {
